 ...
 *
 * Run with: node scripts/migrate-encrypt-users.js
 */
...
async function isEncrypted(text) {
...
async function main() {
  ...
  if (args.includes("--verify")) {
    ...
    console.log(
      "\nTo verify the encryption worked, run: node scripts/migrate-encrypt-users.js --verify"
    );
  }
}
